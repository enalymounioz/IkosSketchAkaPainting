...
class DrawingView(context: Context, attrs: AttributeSet) : View(context, attrs) {
    ...
    private var mDrawPath: CustomPath? = null //A variable of CustomPath

    // inner class to use it further
    private var mCanvasBitmap: Bitmap? = null// An instance of Bitmap
    private var mDrawPaint: Paint? = null // The Paint class holds the style and color
    ...
    private var mBrushSize: Float = 0.toFloat() // A variable for stroke/brush

    // size to draw on the canvas.
    ...
    private fun setUpDrawing() {
        ...
        //mBrushSize = 20.toFloat() //Here the default or we can initialize brush stroke size
